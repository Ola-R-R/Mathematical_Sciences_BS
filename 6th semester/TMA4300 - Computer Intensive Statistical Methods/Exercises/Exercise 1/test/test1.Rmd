...
\begin{align}
  ...
  z' &= g_2(x, y) =  x + y
\end{align} The inverse transformations then becomes
...
$$ Here, $1_{x_i \geq 4}$ is the identity function, i.e. it is 1 when $x_i \geq 4$ and zero otherwise. The normalizing constant is easily found by noting that \begin{align}
