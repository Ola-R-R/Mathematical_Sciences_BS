...
tallen = float(input("Skriv inn et flyttall: "))
tallenint = int(tallen)

tallto = float(input("Skriv inn enda et flyttall: "))
talltoint = int(tallto)

talltre = float(input("Skriv inn et siste flyttall: "))
talltreint = int(talltre)

print(tallenint, talltoint, talltreint)

heltall = int(input("Skriv inn et heltall: "))
heltallfloat = float(heltall)
...
alder = int(input("Hvor gammel var du da du begynte å programmere? "))

antallÅr = Alder - alder

print("Da har du programmert i", antallÅr, "år.")

svar = input("Syns du de " + str(antallÅr) + " årene har vært givende? ")
...
desimalTall = int(input("Hvor mange desimaler er ønskelig? "))

print("Tallet du skreb er", flytTall, "og med", desimalTall, "desimaler blir det", round(flytTall, desimalTall))
