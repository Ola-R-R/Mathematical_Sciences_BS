...
print("Areal (kv.km):", int(385180))

print("Folketall (mill.):", float(5.3))

# Siden oppgavene inneholder heltall og desimaltall brukte jeg int() og float()
...
# Må dele opp i to deler fordi det brukes to forskjellige fnutter i setningen.
